...
That makes it an easy task to implement a user task for resolving conflicts or even implement an automatic conflict resolving procedure.
...
Any employee gets its own database, with one document for a day.
